...
/* Assinging the values to StudentData*/ student.stu_name = "Zhangbuxin"; 
student.stu_id = 123456;
student.stu_age = 21;
/* new structure */
student.stuAddress.street = "4, pr. Nezavisimosti";
student.stuAddress.state = "Minskaya"; student.stuAddress.city = "Minsk"; student.stuAddress.country = "Belarus";
...
%s",
student.stuAddress.country, student.stuAddress.state, student.stuAddress.city, student.stuAddress.street);
printf ("\nGoodbye!"); 
  return 0;
}